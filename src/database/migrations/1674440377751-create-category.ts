...
export class createCategory1674440377751 implements MigrationInterface {
  name = 'createCategory1674440377751';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "category" ADD "image" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
